...
const User = () => {
    ...
    let data3 = [
        {userId: 123, imgSrc:userImg, userName: "Koushil Mankali", reviews: 200, followers: "113"},
        {userId: 124, imgSrc:userImg, userName: "Virat Kohli", reviews: 180, followers: "123"},
        {userId: 125, imgSrc:userImg, userName: "Leonel Messy", reviews: 280, followers: "143"},
        {userId: 125, imgSrc:userImg, userName: "Cristiano Ronaldo", reviews: 120, followers: "153"}
    ]
